...
<div class="admin-wrapper">
   ...
   <div class="admin-content">
    ...
    <div class="button-group">
        <a href="create.php" class="add-btn">أضف تصنيفًا</a>
    </div>
    <!--BUTTON GROUP-->
        ...
        <table>
            ...
            if(!$result){
                ...
                <tr>
                    ...
                    <td><a href="delete.php?tag_id=<?php echo $row['tag_id']; ?>" onclick="return confirm('متأكد من الحذف؟')"" class="delete">حذف</a></td>
                    <td><a href="#" class="pubish">نشر</a></td>
                    <td><a href="edit.php?tag_id=<?php echo $row['tag_id']; ?>" class="edit">تعديل</a></td>
                </tr>
                    <?php
                }
            }
